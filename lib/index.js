// dsh-ecc-skills: engineering skills for the DeepSeek Harness (skills adapted from affaan-m/ECC, MIT).
//
...
//
// Upstream adaptation notes (vs https://github.com/affaan-m/ECC):
//   - Upstream `disable-model-invocation: true` (user-invoked skills) maps
//     to invocation.modelInvocable: false, so
...
/** Register the packaged ecc skill provider on `ctx.skills`. */
function apply(ctx) {
